...
import (
	"ACM_GAME_V2/common/ais/ai_utils/ai_models/chatmodel"
	"context"
	"fmt"
...
func AIWithTools(name, content string, tools []tool.BaseTool, infos []*schema.ToolInfo) *compose.Graph[map[string]string, string] {
